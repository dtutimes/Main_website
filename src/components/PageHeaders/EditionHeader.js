              ...
              <Container>
                <Row>
                  <Col>
                    ...
                    >
                      {" "}
                      <a href={this.state.mob ? this.state.data[0].link : null}>
                        <img
                          alt="..."
                  ...
                  <Col>
                    <Animated
                      ...
                      isVisible={true}
                    >
                      <a href={this.state.mob ? this.state.data[1].link : null}>
                        <img
                          alt="..."
                          className="grid__img layer imgRes"
