        ...
        <Container fluid>
          <Row>
            ...
            <Col className="text-center" md="6">
              ...
              <hr />
              <h5 className="description" style={{ color: "#494850" }}>
                Founded as DCE Times in 2009 by Abhishek Bindal and Anand Meena,
                DTU Times was among the first college newspapers to be published
                across all engineering colleges in India. We have since
                transitioned into its current form as a quarterly newsletter,
                published with the aim of providing essential correspondence,
                news updates and palatable articles to the students of the
                University. DTU Times is also chartered to chronicle the events
                and developments of DTU.
              </h5>
              <br />
            </Col>
            <Col md="3">
